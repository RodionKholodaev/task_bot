...
async def classify_task(description: str) -> dict: 
    ...
    ПРИМЕР 2:
    сегодня 2025-08-20, сходить в МФЦ в понедельник в 17:00 напомни за 2 часа
    Твой ответ:
    {"category": "short_120",
        "date":"2025-08-25",
        "time": "17:00",
    ...
    ПРИМЕР 3:
    сегодня 2026-07-19, нужно через неделю сходить в зал в 19, напомни за день вечером.
    {"category": "short_120",
        "date":"2026-07-26",
        "time": "19:00",
    ...
    ПРИМЕР 4:
    сегодня 2024-11-06, Сегдня в 20 встреча напомни за 2 часа.
    {"category": "short_30",
        "date":"2024-11-06",
        "time": "20:00",
    ...
    ПРИМЕР 5:
    сегодня 2028-06-06, нужно не забыть про созвон в пятницу, напомни в четверг.
    {"category": "short_30",
        "date":"2028-06-09",
        "time": "",
    ...
    ПРИМЕР 6:
    сегодня 2026-02-02, У меня завтра встреча в 13:00, напомни мне за 2 часа.
    {"category": "short_30",
        "date":"2026-02-03",
        "time": "13:00",
