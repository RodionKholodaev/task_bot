...
async def classify_task(description: str) -> dict: # возвращаем один из вариантов из TaskCategory
    """
    ...
    ПРИМЕР 1:
    сегодня 2026-01-31, мне нужно завтра купить после обеда купить наушники для Наташи.
    Твой ответ: 
    {"category": "short_5",
        "date":"2026-02-01",
        "time": "",
