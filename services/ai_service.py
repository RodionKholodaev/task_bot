...
class AiService:
    @staticmethod
    async def ai_parse(description: str, user_id:int,extra_info, session):
        ...
        return await parse_text(description, user_description, extra_info)

    @staticmethod
    async def ai_edit(description: str, date_and_time: str, user_id, extra_info, session):
